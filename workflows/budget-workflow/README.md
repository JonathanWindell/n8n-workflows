...
Open the **"Analyze Receipt"** node to edit the predefined categories (Groceries, Rent, Entertainment, etc.) in the prompt to match your specific budget structure. Do not forget to also implement this as a table etc on google sheets for easier management of expenses. 
